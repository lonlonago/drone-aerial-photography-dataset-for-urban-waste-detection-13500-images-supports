# Drone aerial photography dataset for urban waste detection 13500 images supports Yolo format

# Body

UAV Remote Sensing City Waste Collection Detection Dataset, 13500 images, support Yolo format， .
